...
class AES():
    ...
    ###########################################
    #CITATION: LECTURE 8 CODE BY PROF AVI KAK
    ###########################################
    ...
    def encrypt(self, plaintext:str, ciphertext:str)-> None:
        ...
        for i in range(len(bv_plaintext) // 128):
            ...
            bv ^= self.key_words[0]
            bv_state = self.init_state_array(bv)
            ...
            for round in range(14):
                ...
                bv_state = self.init_state_array(bv)
            ciphertext_bv += self.matchcipher(bv_state)
